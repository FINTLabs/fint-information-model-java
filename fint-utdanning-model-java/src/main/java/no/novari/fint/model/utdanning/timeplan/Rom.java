...
public class Rom implements FintModelObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    TIME("time", "no.novari.fint.model.utdanning.timeplan.Time", NONE_TO_MANY, true, "rom"),
    EKSAMEN(
        "eksamen", "no.novari.fint.model.utdanning.timeplan.Eksamen", NONE_TO_MANY, false, "rom");
