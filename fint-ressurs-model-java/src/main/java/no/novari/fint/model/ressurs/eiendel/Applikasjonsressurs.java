...
public class Applikasjonsressurs implements FintModelObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    BRUKERTYPE(
        "brukertype", "no.novari.fint.model.ressurs.kodeverk.Brukertype", ONE_TO_MANY, null, null),
    HANDHEVINGSTYPE(
        "handhevingstype",
    ...
    LISENSMODELL(
        "lisensmodell",
        "no.novari.fint.model.ressurs.kodeverk.Lisensmodell",
        NONE_TO_ONE,
        null,
        null),
    ...
    APPLIKASJON(
        "applikasjon",
        "no.novari.fint.model.ressurs.eiendel.Applikasjon",
        ONE_TO_ONE,
        false,
        "ressurs");
