...
public class Elev  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        PERSON("person", "no.novari.fint.model.felles.Person", ONE_TO_ONE, "elev"),
        ELEVFORHOLD("elevforhold", "no.novari.fint.model.utdanning.elev.Elevforhold", NONE_TO_MANY, "elev");
