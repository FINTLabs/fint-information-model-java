...
public class Karakterskala extends Begrep implements FintModelObject {
  @Getter
  public enum Relasjonsnavn implements FintRelation {
    VIGOREFERANSE(
        ...
        NONE_TO_ONE,
        null),
    VERDI("verdi", "no.novari.fint.model.utdanning.vurdering.Karakterverdi", NONE_TO_MANY, "skala");
