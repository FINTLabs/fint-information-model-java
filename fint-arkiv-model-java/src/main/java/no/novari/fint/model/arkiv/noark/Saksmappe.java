...
public abstract class Saksmappe extends Mappe implements FintAbstractObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    SAKSMAPPETYPE(
        "saksmappetype", "no.novari.fint.model.arkiv.kodeverk.Saksmappetype", NONE_TO_ONE, null),
    ...
    ADMINISTRATIVENHET(
        ...
        null),
    SAKSANSVARLIG(
        "saksansvarlig", "no.novari.fint.model.arkiv.noark.Arkivressurs", ONE_TO_ONE, null);
