...
public class Kontaktlarergruppemedlemskap extends Gruppemedlemskap  implements FintMetaObject {
    @Getter
    public enum Relasjonsnavn implements FintRelation {
            ELEVFORHOLD("elevforhold", "no.fint.model.utdanning.elev.Elevforhold", ONE_TO_ONE),
            KONTAKTLARERGRUPPE("kontaktlarergruppe", "no.fint.model.utdanning.elev.Kontaktlarergruppe", ONE_TO_ONE);
