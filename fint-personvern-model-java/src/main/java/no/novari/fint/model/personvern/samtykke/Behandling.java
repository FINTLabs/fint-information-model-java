...
public class Behandling implements FintModelObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    BEHANDLINGSGRUNNLAG(
        "behandlingsgrunnlag",
        "no.novari.fint.model.personvern.kodeverk.Behandlingsgrunnlag",
        ONE_TO_ONE,
        null),
    PERSONOPPLYSNING(
        "personopplysning",
        "no.novari.fint.model.personvern.kodeverk.Personopplysning",
        ONE_TO_ONE,
        null),
    SAMTYKKE(
        "samtykke",
        "no.novari.fint.model.personvern.samtykke.Samtykke",
        NONE_TO_MANY,
        "behandling"),
    TJENESTE(
        "tjeneste", "no.novari.fint.model.personvern.samtykke.Tjeneste", ONE_TO_ONE, "behandling");
