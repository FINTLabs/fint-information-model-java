...
public class Leverandor  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ...
        LEVERANDORGRUPPE("leverandorgruppe", "no.fint.model.okonomi.regnskap.Leverandorgruppe", NONE_TO_ONE, null),
        VIRKSOMHET("virksomhet", "no.fint.model.felles.Virksomhet", NONE_TO_ONE, null);
