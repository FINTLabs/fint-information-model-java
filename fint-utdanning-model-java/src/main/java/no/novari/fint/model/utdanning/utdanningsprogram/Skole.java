...
public class Skole extends Enhet implements FintModelObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    ...
    VIGOREFERANSE(
        ...
        null),
    ELEVFORHOLD(
        "elevforhold", "no.novari.fint.model.utdanning.elev.Elevforhold", NONE_TO_MANY, "skole"),
    ...
    KONTAKTLARERGRUPPE(
        ...
        "skole"),
    SKOLERESSURS(
        "skoleressurs", "no.novari.fint.model.utdanning.elev.Skoleressurs", NONE_TO_MANY, "skole"),
    UNDERVISNINGSFORHOLD(
        ...
        "skole"),
    FAGGRUPPE(
        "faggruppe", "no.novari.fint.model.utdanning.timeplan.Faggruppe", NONE_TO_MANY, "skole"),
    UNDERVISNINGSGRUPPE(
        "undervisningsgruppe",
