...
public class Vare extends Begrep  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        FAKTURAUTSTEDER("fakturautsteder", "no.fint.model.okonomi.faktura.Fakturautsteder", ONE_TO_ONE, "vare"),
        MERVERDIAVGIFT("merverdiavgift", "no.fint.model.okonomi.kodeverk.Merverdiavgift", ONE_TO_ONE, null);
