...
public class Person extends Aktor implements FintModelObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    STATSBORGERSKAP(
        "statsborgerskap", "no.novari.fint.model.felles.kodeverk.iso.Landkode", NONE_TO_MANY, null),
    ...
    FORELDREANSVAR(
        "foreldreansvar", "no.novari.fint.model.felles.Person", NONE_TO_MANY, "foreldre"),
    ...
    PARORENDE(
        "parorende", "no.novari.fint.model.felles.Kontaktperson", NONE_TO_MANY, "kontaktperson"),
