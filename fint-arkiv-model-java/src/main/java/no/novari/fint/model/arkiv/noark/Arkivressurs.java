...
public class Arkivressurs  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ...
        AUTORISASJON("autorisasjon", "no.novari.fint.model.arkiv.noark.Autorisasjon", NONE_TO_MANY),
        TILGANG("tilgang", "no.novari.fint.model.arkiv.noark.Tilgang", NONE_TO_MANY);
