...
public class ElevforholdResource extends Utdanningsforhold implements FintResource {
  ...
  @JsonIgnore
  public List<Link> getAnmerkninger() {
    return getLinks().getOrDefault("anmerkninger", Collections.emptyList());
  }

  public void addAnmerkninger(Link link) {
    addLink("anmerkninger", link);
  }
