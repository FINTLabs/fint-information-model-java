...
public class AvlagtProve  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        PROVESTATUS("provestatus", "no.novari.fint.model.utdanning.kodeverk.Provestatus", NONE_TO_ONE, null),
        LARLING("larling", "no.novari.fint.model.utdanning.larling.Larling", ONE_TO_ONE, "avlagtprove"),
        FULLFORTKODE("fullfortkode", "no.novari.fint.model.utdanning.kodeverk.Fullfortkode", NONE_TO_ONE, null),
