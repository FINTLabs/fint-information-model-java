...
public abstract class Registrering implements FintAbstractObject {
  ...
  public enum Relasjonsnavn implements FintRelation {
    TILGANGSGRUPPE(
        "tilgangsgruppe", "no.novari.fint.model.arkiv.kodeverk.Tilgangsgruppe", NONE_TO_ONE, null),
    ADMINISTRATIVENHET(
        "administrativEnhet",
    ...
    SAKSBEHANDLER(
        "saksbehandler", "no.novari.fint.model.arkiv.noark.Arkivressurs", NONE_TO_ONE, null),
