...
public abstract class Registrering  implements FintAbstractObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ...
        SAKSBEHANDLER("saksbehandler", "no.novari.fint.model.arkiv.noark.Arkivressurs", NONE_TO_ONE, null),
        ARKIVERTAV("arkivertAv", "no.novari.fint.model.arkiv.noark.Arkivressurs", ONE_TO_ONE, null),
